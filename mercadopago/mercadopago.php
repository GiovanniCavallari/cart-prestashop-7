...
class Mercadopago extends PaymentModule
{
    ...
    public function getContent()
    {
        ...
        if ($access_token != '' && $sandbox_access_token != '') {
            ...
            //return checkout forms for admin views
    ...
    /**
     * Update checkout for new version
     *
     * @return void
     */
    public function updateOldVersion()
    {
    ...
    public function hookPaymentOptions($params)
    {
        ...
        if (Configuration::get('MERCADOPAGO_STANDARD_CHECKOUT') == true) {
            $standardCheckout = $this->getStandardCheckout($cart);

            $payment_options = [$standardCheckout];
    ...
    public function getStandardCheckout($cart)
    {
        ...
        $standardCheckout->setForm($infoTemplate)
            ->setCallToActionText($this->l('I want to pay with Mercado Pago without additional cost.'))
