    ...
    public function generateForm()
    {
        ...
        $fields = array(
            array(
                'col' => 4,
                'type' => 'switch',
                'label' => $this->module->l('Sandbox Mode', 'CredentialsSettings'),
                'name' => 'MERCADOPAGO_SANDBOX_STATUS',
                'is_bool' => true,
                'desc' => $this->module->l('Choose "YES" to test your store before selling. ', 'CredentialsSettings') .
                    $this->module->l('Switch to "NO" to disable test mode ', 'CredentialsSettings') .
                    $this->module->l('and start receiving online payments.', 'CredentialsSettings'),
                'values' => array(
                    array(
            ...
            array(
                ...
                'name' => '',
                'desc' => '',
                'label' => $this->module->l('Upload credentials', 'CredentialsSettings'),
